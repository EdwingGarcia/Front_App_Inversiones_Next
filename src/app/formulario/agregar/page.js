      ...
      <form action="/inversiones/guardar" method="post" className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="form-group">
            ...
            >
              ...
              {/* Aquí agregas las opciones dinámicas de tipo */}
            </select>
          </div>
          ...
          <div className="form-group">
            ...
            >
              ...
              {/* Aquí agregas las opciones dinámicas de activos */}
            </select>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="form-group">
            ...
            <select
              ...
              required
            >
              <option value="" disabled selected>Selecciona un Broker</option>
              {/* Aquí agregas las opciones dinámicas de brokers */}
            </select>
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          >
            ...
            {/* Aquí agregas las opciones dinámicas de estrategias */}
          </select>
        </div>
